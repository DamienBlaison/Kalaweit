    ...
    */
    ...
    public function update()
    {
        ...
        switch ($_GET["from"]) {
            ...
            if(isset($_GET["cli_id"])) { $to = '/www/Kalaweit/member/get?cli_id='.htmlspecialchars($_GET['cli_id']);}

            if(isset($_GET["cau_id"])) { $to = '/www/Kalaweit/asso_cause/get?cau_id='.htmlspecialchars($_GET['cau_id']);}
