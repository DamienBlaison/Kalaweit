...
namespace Controller\Front\htmlElement;
/**
*
*/
class Table
        ...
        public function render(){
            ...
            foreach ($this->data['content'] as $key => $value) {
                ...
                if($wait == 'OK'){
                    ...
                    $body .=    '<a href="/www/Receipt/'.$name_receipt.'.pdf" target="_blank" style="margin-right:5px;" class="btn btn-success" id="print_'.$value[0].'" ><i class="fa fa-print"></i></a>';
